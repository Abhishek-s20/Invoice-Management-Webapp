...
public class UserPojo {
	...
	public UserPojo(int sl_no, String business_code, String cust_number, String name_customer, String clear_date, String buisness_year, String doc_id, String posting_date,
			String document_create_date, String due_in_date, String invoice_currency, String document_type, String posting_id,
			 String total_open_amount, String baseline_create_date, String cust_payment_terms, String invoice_id,
			 String aging_bucket, String area_business, String isOpen, String is_deleted)
  	{
		this.sl_no = sl_no;
